...
@Component({
  selector: 'app-thismonthlead',
  templateUrl: './thismonthlead.component.html',
  styleUrl: './thismonthlead.component.css'
})

export class ThismonthleadComponent {
leadData: any;
