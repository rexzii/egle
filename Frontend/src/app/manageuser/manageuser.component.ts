...
user_id: any;
  ...
  ngOnInit() {
    ...
    this.registerForm = new FormGroup({
      ...
      user_right:new FormControl(null),
  ...
  handleAddCompanyDetailsButtonClick(): void {
    const companyRegistrationFormSection = document.getElementById("companyRegistrationFormSection");
    if (companyRegistrationFormSection) {
      companyRegistrationFormSection.style.display = "block";
      this.hideOtherSections(["registrationFormSection", "userDetailButtonsDiv"]);
    }
  }
...
navigateTouser(){
  ...
  getallcompanydetails() {
    this.Service.getAllcompanydetails().subscribe(
      (response: any) => {
...
updateActiveStatus(lead: any): void {
  const updatedLead = { 
    ...lead, 
    active: lead.active === true ? 'yes' : 'no'
  };
  this.Service.updateLeadStatus(updatedLead).subscribe(
    (response) => {
